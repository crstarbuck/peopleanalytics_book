...
```{r mdl-yr4-5, out.width = "100%", echo = FALSE, fig.cap = 'Left: Fitted model (red dashed line) against year 4 data in training set (black dots). Right: Fitted model (red dashed line) with poor fit to year 5 data in test set (black dots). The 95% prediction interval is represented by the red shaded area around the fit line.', fig.align = 'center', message = FALSE, warning = FALSE}
