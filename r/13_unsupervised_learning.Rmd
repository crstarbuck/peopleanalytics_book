...
```{r kmeans-elbow-plot, out.width = "100%", echo = FALSE, message = FALSE, warning = FALSE, fig.cap = 'Total within sum of squares (WSS) across cluster count.', fig.align = 'center'}
...
```
  ...
  **Hierarchical Clustering**
  ...
  2. Group observations into clusters
