...
```
  ...
  In this example, using the default Pearson method, the covariance between total working years and age is 453179.1. The positive value indicates that total working years is generally higher for older employees and lower for younger employees.
