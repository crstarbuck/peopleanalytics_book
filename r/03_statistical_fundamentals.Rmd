...
```
  ...
  94% of sample means are within our 95% CI (+/- 1.96 standard errors), which is very close to the expected 95% per the Empirical Rule covered previously. 1.96 is a z-score, which is simply the number of standard deviations (or SEs in this case) that correspond to the 95% CI.
...
```
  ...
  99% of the sample means are within the 99% CI (+/- 2.58 standard errors), indicating that it would be highly unlikely -- nearly impossible even -- to observe a sample mean `from the same population` that falls outside this interval.
