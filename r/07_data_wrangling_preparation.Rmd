...
```{r dw-erd, out.width = "100%", echo = FALSE, fig.cap = 'Entity Relationship Diagram (ERD)', fig.align = 'center'}
...
```
  ...
  For variables with more than 2 categories, we can leverage the `model.matrix()` function to one-hot encode them all:
