...
```{r ww2-plane-damage, out.width = "75%", echo = FALSE, fig.cap = 'Hypothetical data for damaged portions of returning WWII planes. Image courtesy of Cameron Moll (2005).', fig.align = 'center'}
