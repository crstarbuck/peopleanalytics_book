...
p_bernoulli <- 
      ...
      ggplot() + 
      aes(bernoulli_dist) + 
      labs(title = "Bernoulli", x = "x", y = "count") + 
...
p_binomial <- 
      ...
      ggplot() + 
      aes(binomial_dist) + 
      labs(title = "Binomial", x = "x", y = "count") + 
      theme(plot.title = element_text(hjust = 0.5)) + 
      geom_histogram(fill = "#414141") +
      theme_bw()
...
p_multinomial <- 
      ...
      ggplot() + 
      aes(multinomial_dist) + 
      labs(title = "Multinomial", x = "x", y = "count") + 
      theme(plot.title = element_text(hjust = 0.5)) + 
      geom_histogram(fill = "#414141") +
      theme_bw()
...
p_nbinomial <- 
      ...
      ggplot() + 
      aes(nbinomial_dist) + 
      labs(title = "Negative Binomial", x = "x", y = "count") + 
      theme(plot.title = element_text(hjust = 0.5)) + 
      geom_histogram(fill = "#414141") +
      theme_bw()
...
p_poisson <- 
      ...
      ggplot() + 
      aes(poisson_dist) + 
      labs(title = "Poisson", x = "x", y = "count") + 
      theme(plot.title = element_text(hjust = 0.5)) + 
      geom_histogram(fill = "#414141") +
      theme_bw()
...
p_geometric <- 
      ...
      ggplot() + 
      aes(geometric_dist) + 
      labs(title = "Geometric", x = "x", y = "count") + 
      theme(plot.title = element_text(hjust = 0.5)) + 
      geom_histogram(fill = "#414141") +
      theme_bw()

# Display distribution visualizations
ggarrange(p_bernoulli, p_binomial, p_multinomial, p_nbinomial, p_poisson, p_geometric,
                             ncol = 3, nrow = 2)
