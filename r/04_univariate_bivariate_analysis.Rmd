...
```{r skewness, out.width="50%", echo = FALSE, fig.cap = 'Skewness', fig.align = 'center'}
...
```{r corr-table, out.width="50%", echo = FALSE, fig.cap = 'Proper Applications of Correlation Coefficients', fig.align = 'center'}
...
```{r spur-corr-1, out.width="50%", echo = FALSE, fig.cap = 'Correlation between Maine Divorce Rate and Margarine Consumption (r = .99)', fig.align = 'center'}
...
```{r spur-corr-2, out.width="50%", echo = FALSE, fig.cap = 'Correlation between Mozzarella Cheese Consumption and Civil Engineering Doctorate Conferrals (r = .96)', fig.align = 'center'}
