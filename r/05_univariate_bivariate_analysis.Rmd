...
ggplot(employees, aes(x = as.factor(ed_lvl), y = annual_comp, color = gender)) +
...
round(skewness(employees$org_tenure), 2)
...
round(kurtosis(employees$org_tenure), 1)
...
cov(employees[, c("annual_comp", "age", "org_tenure", "job_tenure", "prior_emplr_cnt", "commute_dist")], use = "complete.obs")
...
cor(employees[, c("annual_comp", "age", "org_tenure", "job_tenure", "prior_emplr_cnt", "commute_dist")], use = "complete.obs")
...
# Visualize correlation matrix
ggpairs(employees[, c("annual_comp", "age", "org_tenure", "job_tenure", "prior_emplr_cnt", "commute_dist")])
