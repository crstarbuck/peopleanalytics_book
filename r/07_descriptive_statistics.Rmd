...
```
  ...
  Box plot alternatives, such as violin, raincloud, and jittered strip plots, are often more helpful in understanding data distributions. Figure \@ref(fig:boxplot-alt) shows the juxtaposition of a raincloud plot against a box plot. While it may seem like an oxymoronic, in this case the spread of data is clearer in the rain.
