# Getting Started {#getting-started}
  ...
  The goal of this book is not to boil the ocean by compiling and implementing every analysis method, from every point of view, in every tool. This book employs the Pareto Principle in that it represents the foundational knowledge and skills required to successfully design and execute the *majority* of projects in the people analytics domain.
...
## R
  ...
  Applications in this book are demonstrated in R. All code has been written such that it is fully reproducible should you choose to follow along on your machine (and I highly recommend you do).
