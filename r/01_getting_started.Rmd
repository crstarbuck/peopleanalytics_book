...
### Data
  ...
  * `turnover_rate`: Overall trailing 12-month (TTM) turnover rate, calculated by dividing the termination count into the average end-of-month headcount for the respective TTM period
