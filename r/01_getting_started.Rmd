...
### Data
  ...
  * `turnover_rate`: Overall trailing 12-month turnover rate, calculated by dividing the termination count into the average end-of-month headcount for the respective trailing 12-month period
