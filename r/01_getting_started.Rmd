...
<i>
```{r sci-method, out.width="50%", echo = FALSE, fig.cap = 'The Scientific Method', fig.align = 'center'}
...
<i>
```{r 4d-framework, out.width="50%", echo = FALSE, fig.cap = '4D Framework', fig.align = 'center'}
