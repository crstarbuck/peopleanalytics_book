...
ggplot2::annotate(geom = "text", x = 2.1, y = 53, label = paste0("Treatment Group \n(", ifelse(treatment_chg >= 0, '+', ''), treatment_chg,")"), color = "#0070C0", size = 4, hjust = 0) +
ggplot2::annotate(geom = "text", x = 2.1, y = 14, label = paste0("Control Group \n(", ifelse(control_chg >= 0, '+', ''), control_chg,")"), color = "#808080", size = 4, hjust = 0) +
