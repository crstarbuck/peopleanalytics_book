...
DT::datatable(dept_tenure, rownames = FALSE)
...
### Sankey Diagrams
  ...
  **Sankey diagrams**, or alternatives such as **chord diagrams** and **alluvial plots**, are flow diagrams that are particularly effective in depicting a many-to-many relationship between two domains. In a sankey, connection points are links and the items being connected are nodes.
...
```{r good-viz, out.width = "75%", echo = FALSE, fig.cap = 'An archetype of elegance in data visualization.', fig.align = 'center'}
