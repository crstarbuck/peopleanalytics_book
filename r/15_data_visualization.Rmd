...
### Combination Charts
  ...
  **Combination charts** involve a combination of multiple types of visualizations.
  
  In a people analytics context, we may wish to highlight differences between voluntary and involuntary turnover trends relative to overall monthly turnover rates. It is usually more difficult to interpret how the magnitude of voluntary and involuntary rates compare across time using a stacked bar chart, and a combo chart is often a more intuitive method of presenting this information.
  
  As illustrated in Figure \@ref(fig:combo-chart), we can leverage a two-series line chart for monthly voluntary and involuntary rates relative to the overall monthly turnover rate visualized with a light grey vertical bar chart in the background.
