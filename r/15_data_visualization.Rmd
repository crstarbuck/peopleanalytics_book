...
### Waffle Charts
  ...
  **Waffle charts**, also known as **square area charts**, are well-suited for illustrating parts of a whole.
  ...
  A common application in people analytics is illustrating candidate movement through the recruiting funnel. It is often helpful to visualize a normalized applicant pool (e.g., per 100 or 1k applicants) to identify how the health of funnel stages compares across business areas. The waffle chart in Figure \@ref(fig:waffle-chart) illustrates how candidates for a set of filled requisitions move from application through the phone screen, onsite interview, offer extend, and offer acceptance stages of the recruiting lifecycle.

```{r waffle-chart, out.width = "100%", fig.cap = 'Waffle chart showing pass-through rates per 1k job applicants.', fig.align = 'center', message = FALSE, warning = FALSE}
