...
### Step 4: Add Mixed Case Axis Labels in Grey
...
### Step 5: Add Centered Title in Grey
...
```{r barchart_10, out.width = "100%", fig.cap = 'Step 10: Sort data along flipped axis.', fig.align = 'center', message = FALSE, warning = FALSE}
...
```{r pre-post-declutter, out.width = "100%", fig.cap = "Top: Design defaults (pre). Bottom: Enhanced design (post).", fig.align = 'center', warning = FALSE, message = FALSE}
