...
```
  ...
  **Multiple Series**
  ...
  A **multiple series line graph** reflects trends for three or more groups, as shown in Figure \@ref(fig:multi-line-graph).
...
```{r vbar-chart, out.width = "100%", echo = FALSE, fig.cap = 'Horizontal bar chart.', fig.align = 'center', message = FALSE, warning = FALSE}
