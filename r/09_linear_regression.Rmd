...
```{r slm-fit, out.width = "100%", echo = FALSE, fig.cap = 'Simple Linear Model Fit Line for y = 20.1x + 5.1', fig.align = 'center', message = FALSE, warning = FALSE}
