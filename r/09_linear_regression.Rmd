...
```  
  ...
  To better understand the nature of the interaction effect ($\beta$ = -2.51, $t$(405) = -8.39, $p$ < .001), two equations can be built to evaluate changes in the slope of the relationship with low ($\bar{x}$ - 1$s$) and high ($\bar{x}$ + 1$s$) organization tenure:
  
  * *Low organization tenure*: $Y = 123.84 - 2.51 (6.57 - 5.12) * X$)
  * *High organization tenure*: $Y = 123.84 - 2.51 (6.57 + 5.12) * X$), 
