...
install.packages(c("tidyverse", "corrplot", "psych", "moments", "ggpubr", "GGally", "sqldf", "caret", "car", "reshape2", "flextable", "lmtest", "equatiomatic", "pwr", "nnet", "MASS", "brant", "lme4", "lmerTest", "rpart", "rpart.plot", "lavaan", "lavaanPlot", "factoextra"), dependencies = TRUE, repos = "http://cran.us.r-project.org")
