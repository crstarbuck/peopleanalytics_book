...
install.packages(c("tidyverse", "corrplot", "psych", "moments", "ggpubr", "GGally", "sqldf", "caret", "car", "reshape2", "flextable"), dependencies = TRUE, repos = "http://cran.us.r-project.org")
