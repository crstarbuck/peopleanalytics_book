...
install.packages(c("tidyverse", "corrplot", "psych", "moments", "ggpubr", "ggdist", "GGally", "networkD3", "sqldf", "caret", "car", "reshape2", "effsize", "lmtest", "equatiomatic", "pwr", "nnet", "MASS", "brant", "lme4", "lmerTest", "rpart", "rpart.plot", "lavaan", "lavaanPlot", "factoextra", "cluster"), dependencies = TRUE, repos = "http://cran.us.r-project.org")
