...
```
  ...
  We can instead specify the library in the function call using `::` between the library and function name. This will load the library without having to run the `library()` function independently. This is also a best practice for efficient coding, as R Studio will provide a menu of available functions within the specified library upon typing `library_name::`.
