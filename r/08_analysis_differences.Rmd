...
```{r mean-group-diff, out.width = "100%", echo = FALSE, fig.cap = 'Deceptive Density Plots. Figure A: Statistically significant mean differences (MD = 1, n = 50, p < .05). Figure B: Statistically insignificant mean differences (MD = 87, n = 50, p > .05).', fig.align = 'center', message = FALSE, warning = FALSE}
