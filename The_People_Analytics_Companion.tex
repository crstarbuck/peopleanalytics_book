...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//Rtmp9HpffM/downloaded_packages
\end{verbatim}
...
{\centering \includegraphics{The_People_Analytics_Companion_files/figure-latex/org-tenure-distribution-1} 
...
{\centering \includegraphics{The_People_Analytics_Companion_files/figure-latex/discrete-dist-1} 
...
{\centering \includegraphics{The_People_Analytics_Companion_files/figure-latex/unnamed-chunk-91-1} 

}

\caption{Uniform Population Distribution (N = 1000)}\label{fig:unnamed-chunk-91}
\end{figure}
...
In R, we can build (or \emph{fit}) a simple linear regression model using the \texttt{lm()} function. The syntax is \texttt{lm(Y\ \textasciitilde{}\ X,\ dataset)}. Let's fit a linear model to regress YTD sales on engagement and use the \texttt{flextable} package to present model results in a more elegant tabular summary than the base R default:
...
\CommentTok{# Subset employees data frame; sales are only applicable for those in sales positions}
...
\CommentTok{# Regress YTD sales on engagement}
\NormalTok{slm.fit <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(ytd_sales }\OperatorTok{~}\StringTok{ }\NormalTok{engagement, data)}
...
\begin{longtable}[c]{|p{1.13in}|p{1.05in}|p{1.29in}|p{0.75in}|p{0.75in}|p{0.75in}}
...
\multicolumn{6}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedleft}p{\dimexpr 5.72in+10\tabcolsep+5\arrayrulewidth}!{\color[HTML]{FFFFFF}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{\textit{Signif.\ codes:\ 0\ <=\ '***'\ <\ 0.001\ <\ '**'\ <\ 0.01\ <\ '*'\ <\ 0.05\ <\ '.'\ <\ 0.1\ <\ ''\ <\ 1}}}}} \\





\multicolumn{6}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.72in+10\tabcolsep+5\arrayrulewidth}!{\color[HTML]{FFFFFF}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{}}}} \\





\multicolumn{6}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.72in+10\tabcolsep+5\arrayrulewidth}!{\color[HTML]{FFFFFF}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Residual\ standard\ error:\ 5.274e+04\ on\ 407\ degrees\ of\ freedom}}}} \\





\multicolumn{6}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.72in+10\tabcolsep+5\arrayrulewidth}!{\color[HTML]{FFFFFF}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Multiple\ R-squared:\ 0.1236,\ Adjusted\ R-squared:\ 0.1214}}}} \\





\multicolumn{6}{!{\color[HTML]{FFFFFF}\vrule width 0pt}>{\raggedright}p{\dimexpr 5.72in+10\tabcolsep+5\arrayrulewidth}!{\color[HTML]{FFFFFF}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{F-statistic:\ 57.39\ on\ 407\ and\ 1\ DF,\ p-value:\ 0.0000}}}} \\

\endfoot



\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 1.13in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{(Intercept)}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.05in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{2,431.673}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.29in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{10,321.632}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{0.236}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{0.8139}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{}}}} \\





\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 1.13in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{engagement}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.05in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{28,002.666}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 1.29in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{3,696.432}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{7.576}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{0.0000}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{***}}}} \\
...
\tightlist
\item
  \texttt{Estimate}: \emph{Unstandardized} Beta coefficient associated with the respective predictor
\item
...
\item
  \texttt{Multiple\ R-squared}: Percent of variance in \(y\) (when multiplied by 100) explained by the predictors in the model. This is also known as the \textbf{Coefficient of Determination}. For simple linear regression, this is simply the squared value of Pearson's \(r\) for the bivariate relationship between the predictor and response (execute \texttt{cor(data\$engagement,\ data\$ytd\_sales)\^{}2} to validate).
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(slm.fit}\OperatorTok{$}\NormalTok{resid, }\DataTypeTok{main =} \StringTok{"Distribution of Model Residuals"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Sales Estimate Residuals"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{las =} \DecValTok{1}\NormalTok{, }\DataTypeTok{breaks =} \DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{The_People_Analytics_Companion_files/figure-latex/unnamed-chunk-166-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Define a vector of predictors}
\NormalTok{predictors <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"engagement"}\NormalTok{, }\StringTok{"job_lvl"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Execute lines 104-109 below. Determine the two predictors associated with the largest absolute pairwise correlation (whether they are positively or negatively related does not matter) -- call them predictors A and B. The code below makes this easy as it orders pairs of predictors based on their absolute correlation (from highest to lowest), so you only need to look at the first row in the output.
\item
  Execute lines 113-114 below to build a correlation matrix for the predictors. Determine the average absolute correlation between predictor A and the other variables. Do the same for predictor B. The combination of the summary() and abs() functions on line 114 enables an easy evaluation of which predictor is more highly correlated with other predictors (simply compare the \texttt{mean} for the predictors of interest).
\item
  If predictor A has a larger average absolute correlation, remove it from the \texttt{predictors} vector; otherwise, remove predictor B. The exception to this rule is when predictors A and B have similar average absolute correlations with all other predictors but the predictor with the slightly higher correlation is a key variable that, if dropped, will prevent you from addressing one or more stated objectives for this assignment (be sure to reread the overall purpose for this assignment if this is unclear).
\item
  Repeat steps 1-3 until no absolute correlations are \textgreater{}= .7.
\end{enumerate}

All variables for this assignment are numeric (no categorical variables), which means we can simply evaluate correlations among all without any dummy coding. The code below will create a correlation matrix using the predictors specified in the \texttt{predictors} vector initialized at the beginning of this script.

As you iteratively address multicollinearity issues using the aforementioned approach, simply remove from the \texttt{predictors} vector the variable you wish to omit and then execute that line of code again to inform R that the predictors have been updated. You can then re-execute the code below to produce a new correlation matrix with the revised subset of predictors.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{M1 <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(data[ ,}\KeywordTok{paste}\NormalTok{(predictors)]), }\DecValTok{2}\NormalTok{) }\CommentTok{# Build a correlation matrix named M1.}
\NormalTok{M1[M1 }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{] <-}\StringTok{ }\OtherTok{NA} \CommentTok{# Drop perfect correlations (e.g., relationships of variables with themselves).}
\NormalTok{M1 <-}\StringTok{ }\KeywordTok{na.omit}\NormalTok{(reshape2}\OperatorTok{::}\KeywordTok{melt}\NormalTok{(M1)) }\CommentTok{# Melt the data; convert columns into rows for ease of use.}
\NormalTok{M1 <-}\StringTok{ }\NormalTok{M1[}\KeywordTok{order}\NormalTok{(}\OperatorTok{-}\KeywordTok{abs}\NormalTok{(M1}\OperatorTok{$}\NormalTok{value)),] }\CommentTok{# Sort order the data.}
\KeywordTok{colnames}\NormalTok{(M1) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Variable 1"}\NormalTok{, }\StringTok{"Variable 2"}\NormalTok{, }\StringTok{"Correlation"}\NormalTok{) }\CommentTok{# Assign meaningful names to the columns in the matrix.}
\NormalTok{M1 }\CommentTok{# Display contents of the matrix.}
\end{Highlighting}
\end{Shaded}
...
## 3 engagement    job_lvl        0.04
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{M2 <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(data[ ,}\KeywordTok{paste}\NormalTok{(predictors)]), }\DecValTok{2}\NormalTok{) }\CommentTok{# Build a correlation matrix named M2.}
\KeywordTok{summary}\NormalTok{(}\KeywordTok{abs}\NormalTok{(M2)) }\CommentTok{# Display descriptive stats for the absolute value of each bivariate relationship to inform which variables to drop.}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# car::vif(mlm(paste("ytd_sales ~ ", paste(predictors, collapse = "+")), data))}
\end{Highlighting}
\end{Shaded}

\hypertarget{fit-linear-model-with-subset-of-important-variables}{%
\section{Fit Linear Model (with Subset of Important Variables)}\label{fit-linear-model-with-subset-of-important-variables}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# mlm.fit.sub <- lm(paste("ytd_sales ~ ", paste(predictors, collapse = "+")), data)}
\CommentTok{# summary(lm.fit.sub)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Remove the predictor with the highest p-value greater than the critical value (.05).
\item
  Refit the model (i.e., modify the `predictors' vector to exclude the irrelevant variable, and then re-execute lines 122-123 to refit the linear model and display output), and repeat step 1.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# mlm.fit.sub.scaled <- lm(paste0("scale(ytd_sales) ~ scale(", paste(predictors, collapse = ")+scale("),")"), data)}
\CommentTok{# summary(mlm.fit.sub.scaled)}
\end{Highlighting}
\end{Shaded}
