...
{\centering \includegraphics{The_Fundamentals_of_People_Analytics_files/figure-latex/unnamed-chunk-130-1} 
...
\NormalTok{treat\_metrics }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{pre\_ind =} \FunctionTok{length}\NormalTok{(treat\_ids),}
                           ...
                           \AttributeTok{post\_ind =} \FunctionTok{length}\NormalTok{(treat\_ids), }
                           \AttributeTok{diff =} \FunctionTok{length}\NormalTok{(treat\_ids))}

\NormalTok{ctrl\_metrics }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{pre\_ind =} \FunctionTok{length}\NormalTok{(ctrl\_ids), }
                          ...
                          \AttributeTok{post\_ind =} \FunctionTok{length}\NormalTok{(ctrl\_ids),}
                          \AttributeTok{diff =} \FunctionTok{length}\NormalTok{(ctrl\_ids))}
...
\NormalTok{one.way }\OtherTok{\textless{}{-}} \FunctionTok{aov}\NormalTok{(annual\_comp }\SpecialCharTok{\textasciitilde{}} \FunctionTok{as.factor}\NormalTok{(job\_sat), }\AttributeTok{data =}\NormalTok{ employees)}
...
\FunctionTok{kruskal.test}\NormalTok{(annual\_comp }\SpecialCharTok{\textasciitilde{}} \FunctionTok{as.factor}\NormalTok{(job\_sat), }\AttributeTok{data =}\NormalTok{ employees)}
\end{Highlighting}
\end{Shaded}
...
## 
## data:  annual_comp by as.factor(job_sat)
...
\NormalTok{factorial }\OtherTok{\textless{}{-}} \FunctionTok{aov}\NormalTok{(annual\_comp }\SpecialCharTok{\textasciitilde{}} \FunctionTok{as.factor}\NormalTok{(job\_sat) }\SpecialCharTok{+} \FunctionTok{as.factor}\NormalTok{(stock\_opt\_lvl), }\AttributeTok{data =}\NormalTok{ employees)}
...
While mean annual compensation is significantly different across job satisfaction levels, this output alone is not too helpful in understanding the nature of the differences. Statistical significance markers indicate that there are meaningful differences that warrant a deeper understanding. Relationships of job satisfaction and stock option level with annual compensation are illustrated more effectively in Figure \ref{fig:two-way-factorial}.
...
\NormalTok{multinom.fit }\OtherTok{\textless{}{-}}\NormalTok{ nnet}\SpecialCharTok{::}\FunctionTok{multinom}\NormalTok{(dept }\SpecialCharTok{\textasciitilde{}}\NormalTok{ overtime }\SpecialCharTok{+}\NormalTok{ ed\_field, }\AttributeTok{data =}\NormalTok{ employees)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{prediction\_dat }\OtherTok{\textless{}{-}}\NormalTok{ employees}
...
\CommentTok{\# Note: centroid is not available for agnes() function}
...
\CommentTok{\# Build data frame with hire and term metrics by department}
\NormalTok{hires\_terms }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{dept =} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}Engineering\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Finance\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Legal\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Marketing\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}People\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Product\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Sales\textquotesingle{}}\NormalTok{),}
                          \AttributeTok{metric =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}Hires\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Terms\textquotesingle{}}\NormalTok{), }\DecValTok{7}\NormalTok{),}
                          \AttributeTok{cnt =} \FunctionTok{round}\NormalTok{(}\FunctionTok{runif}\NormalTok{(}\DecValTok{14}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{150}\NormalTok{), }\DecValTok{0}\NormalTok{))}

\CommentTok{\# Append transformed count column to support bidirectional bar charts}
\NormalTok{hires\_terms}\SpecialCharTok{$}\NormalTok{cnt\_trans }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(hires\_terms}\SpecialCharTok{$}\NormalTok{metric }\SpecialCharTok{==} \StringTok{\textquotesingle{}Terms\textquotesingle{}}\NormalTok{, }\DecValTok{0} \SpecialCharTok{{-}}\NormalTok{ hires\_terms}\SpecialCharTok{$}\NormalTok{cnt, hires\_terms}\SpecialCharTok{$}\NormalTok{cnt)}
\end{Highlighting}
\end{Shaded}

Using the \texttt{cnt\_trans} field containing both negative and positive integers, we can visualize net changes in departmental headcount.
...
{\centering \includegraphics[width=1\linewidth]{graphics/sankey_2} 
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\#\# Bidirectional Bar Chart Data Prep }\AlertTok{\#\#\#}
