...
\hypersetup{
  pdftitle={A Practitioner's Guide to People Analytics with R},
  pdfauthor={Craig Starbuck},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A Practitioner's Guide to People Analytics with R}
...
The goal of this book is not to boil the ocean by compiling and implementing every analysis method, from every point of view, in every tool. This book is guided by a goal of optimizing for the \emph{fewest} number of concepts and applications required to successfully design and execute the \emph{majority} of projects in the people analytics domain. Though this is a technical book, there is an emphasis on concepts and practical applications to people analytics over the mathematical underpinnings.
...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpshNOuo/downloaded_packages
\end{verbatim}
...
\includegraphics{People_Analytics_Guide_files/figure-latex/unnamed-chunk-51-1.pdf}
...
\includegraphics{People_Analytics_Guide_files/figure-latex/unnamed-chunk-52-1.pdf}
...
Note that rows where \texttt{end\_date} is null indicate \emph{current attributes} for active workers. For inactive workers, \texttt{end\_date} is set to the worker's termination date for rows that represent \emph{last known attributes}:
...
To construct a view of the last known attributes for each worker in this table, we could select rows where \texttt{end\_date} is null for active workers and the most recent rows (max date) for inactive workers, but this approach would be unnecessarily complex. Using a Type 1 table simplifies the task and output since each dimension value is stored in a separate column and there is only one row per employee. Figure \ref{fig:type-1-tbl} shows how the current record for worker 123 would look in a Type 1 SCD:
...
\includegraphics{People_Analytics_Guide_files/figure-latex/unnamed-chunk-105-1.pdf}
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/org-tenure-distribution-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/corrplot-comp-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ggpairs-comp-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/org-tenure-dist-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/discrete-dist-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/continous-dist-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/unnamed-chunk-126-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/unnamed-chunk-127-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/chisq-dist-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/mosaic-plot-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/mean-group-diff-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/comp-job-boxplots-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/pre-post-diff-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/comp-dist-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/qq-plot-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/qq-plots-trans-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/two-way-factorial-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/lm-residuals-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/lm-fit-compare-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/high-leverage-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/slm-diagnostics-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/slm-residuals-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/slm-fit-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ggpairs-ytd-sales-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/pre-mlm-diagnostics-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/post-mlm-diagnostics-1} 
...
{\centering \includegraphics{People_Analytics_Guide_files/figure-latex/mlm-residuals-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/int-effects-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/poly-fun-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ps-turnover-trends-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/turnover-pred-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ps-turnover-yrly-dist-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/lm-glm-compare-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ot-dept-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ed-field-dept-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/class-mdl-perf-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/var-imp-plot-1} 
...
{\centering \includegraphics[width=0.75\linewidth]{People_Analytics_Guide_files/figure-latex/rpart-tree-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/mdl-yr4-5-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/scree-plot-1} 
...
\NormalTok{ggplot2}\SpecialCharTok{::}\FunctionTok{xlab}\NormalTok{(}\StringTok{"Principal Component"}\NormalTok{) }\SpecialCharTok{+} 
\NormalTok{ggplot2}\SpecialCharTok{::}\FunctionTok{ylab}\NormalTok{(}\StringTok{"Variance Explained (\%)"}\NormalTok{) }\SpecialCharTok{+}
\NormalTok{ggplot2}\SpecialCharTok{::}\FunctionTok{theme\_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/pca-var-plot-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/fct-ld-diagram-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/ggpairs-eng-ret-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/kmeans-elbow-plot-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/hclust-dendogram-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/hclust-gap-stat-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/baseline-compare-1} 
...
When visualizing data, it is best not to deviate from the way in which the audience will naturally interpret the data. For example, numbers lower on a \(y\)-axis will naturally be interpreted to be smaller than numbers higher on the \(y\)-axis. If there are both positive and negative numbers along an \(x\)-axis, negative metrics are best placed on the left and positive on the right since people naturally consume content from left to right.
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/pre-attr-2-1} 
...
\hypertarget{beyond-the-defaults}{%
\section{Beyond the Defaults}\label{beyond-the-defaults}}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-1-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-2-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-3-1} 
...
\hypertarget{step-4-add-mixed-case-axis-titles}{%
\subsection{Step 4: Add Mixed Case Axis Titles}\label{step-4-add-mixed-case-axis-titles}}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-4-1} 
...
We can add a chart title via \texttt{labs(title\ =\ \textquotesingle{}This\ is\ a\ chart\ title.\textquotesingle{})}. This title can be centered via \texttt{theme(plot.title\ =\ element\_text(hjust\ =\ 0.5)}, left justified via \texttt{theme(plot.title\ =\ element\_text(hjust\ =\ 0)}, or right justified via \texttt{theme(plot.title\ =\ element\_text(hjust\ =\ 1)}.
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-5-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-6-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-7-1} 
...
We can change the color of the chart title to light grey with \texttt{plot.title\ =\ element\_text(colour\ =\ "\#404040")}. The axis titles can be changed to the same color using \texttt{axis.title.x\ =\ element\_text(colour\ =\ "\#404040")} for the x-axis and \texttt{axis.title.y\ =\ element\_text(colour\ =\ "\#404040")} for the y-axis.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-8-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-9-1} 
...
This visual can be further simplified by sorting the bars from highest to lowest value.

We can use \texttt{dplyr} to sort the data and define the levels of \texttt{ed\_field}.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Sort education values by count}
\NormalTok{smmry\_ed\_field }\OtherTok{\textless{}{-}}\NormalTok{ smmry\_ed\_field }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{                  dplyr}\SpecialCharTok{::}\FunctionTok{arrange}\NormalTok{(n)}

\NormalTok{smmry\_ed\_field}\SpecialCharTok{$}\NormalTok{ed\_field }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(smmry\_ed\_field}\SpecialCharTok{$}\NormalTok{ed\_field, }\AttributeTok{levels =}\NormalTok{ smmry\_ed\_field}\SpecialCharTok{$}\NormalTok{ed\_field)}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/barchart-10-1} 
...
\NormalTok{viz\_post }\OtherTok{\textless{}{-}}\NormalTok{ ggplot2}\SpecialCharTok{::}\FunctionTok{ggplot}\NormalTok{(smmry\_ed\_field, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ ed\_field, }\AttributeTok{y =}\NormalTok{ n, }\AttributeTok{fill =} \FunctionTok{as.factor}\NormalTok{(ed\_field))) }\SpecialCharTok{+}
...
\NormalTok{            ggplot2}\SpecialCharTok{::}\FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{,}
                           ...
                           \AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \DecValTok{0}\NormalTok{, }\AttributeTok{colour =} \StringTok{"\#404040"}\NormalTok{),}
                           \AttributeTok{axis.title.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{colour =} \StringTok{"\#404040"}\NormalTok{),}
                           \AttributeTok{axis.title.y =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{colour =} \StringTok{"\#404040"}\NormalTok{))}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/pre-post-declutter-1} 
...
Figure \ref{fig:cumulative-trend} shows a cumulative graph of iPhone sales. Since sales at each point in time are additive, the slope of the cumulative line is positive and steep. Superimposing a bar chart with non-cumulative quarterly sales atop a cumulative trend -- which occupies far more real estate and dominates the screen -- can lend to the audience drawing invalid conclusions from the data.
...
\caption{Deceiving cumulative sales trend.}\label{fig:cumulative-trend}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Load turnover data}
\NormalTok{turnover }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/crstarbuck/peopleanalytics\_book/master/data/turnover\_trends.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/single-line-graph-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/double-line-graph-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/multi-line-graph-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/vbar-chart-1} 

}

\caption{Horizontal bar chart.}\label{fig:vbar-chart}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/hbar-chart-1} 
...
\NormalTok{                dplyr}\SpecialCharTok{::}\FunctionTok{summarise}\NormalTok{(}\AttributeTok{cnt =} \FunctionTok{n}\NormalTok{()) }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{ggplot2}\SpecialCharTok{::}\FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.title =} \FunctionTok{element\_blank}\NormalTok{(),}
               \AttributeTok{panel.background =} \FunctionTok{element\_blank}\NormalTok{(),}
               \AttributeTok{axis.ticks.x =} \FunctionTok{element\_blank}\NormalTok{(),}
               \AttributeTok{axis.ticks.y =} \FunctionTok{element\_blank}\NormalTok{(),}
               \AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{colour =} \StringTok{"\#404040"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{People_Analytics_Guide_files/figure-latex/pie-chart-1} 
...
{\centering \includegraphics[width=0.75\linewidth]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_book/graphics/horizontal_bar_chart} 
...
{\centering \includegraphics[width=0.75\linewidth]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_book/graphics/good_viz-job_loss} 

}

\caption{Masterfully constructed bar chart.}\label{fig:good-viz}
\end{figure}
...
\item
  What is the utility of preattentive attributes?
\item
