...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//Rtmp7hSxjp/downloaded_packages
\end{verbatim}
...
{\centering \includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-115-1} 
...
{\centering \includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-116-1} 
...
{\centering \includegraphics[width=0.75\linewidth]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_lifecycle_book/graphics/stats_ml_satire} 
...
The development of survey instrumentation, whether a single item or a larger multidimensional scale, begins with a good theory. The theory provides the conceptual support for the construct -- the particular dimensions that characterize the construct, the antecedent variables which theoretically influence it, and the outcomes it will likely drive. With a strong theoretical framework, the researcher can begin proposing ways of \emph{operationalizing} the conceptual scheme into a measurement approach.
...
\textbf{Exploratory factor analysis (EFA)} is a variable reduction technique by which factors are extracted from data as part of the development process for new survey instruments.
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Lifecycle_files/figure-latex/ggpairs-eng-ret-1} 
...
\begin{verbatim}
## Warning: package 'lavaanPlot' was built under R version 4.0.2
\end{verbatim}
...
##                                                       
##   Test statistic                               116.834
##   Degrees of freedom                                 8
##   P-value (Chi-square)                           0.000
## 
## Model Test Baseline Model:
## 
##   Test statistic                              3247.688
...
## 
##   Loglikelihood user model (H0)              -6391.875
##   Loglikelihood unrestricted model (H1)      -6333.457
##                                                       
##   Akaike (AIC)                               12809.749
##   Bayesian (BIC)                             12873.550
##   Sample-size adjusted Bayesian (BIC)        12832.261
## 
...
##   engagement =~                                       
##     eng_1             1.000                           
##     eng_2             0.879    0.031   28.448    0.000
##     eng_3             0.913    0.034   26.851    0.000
##   retention =~                                        
##     ret_1             1.000                           
##     ret_2             0.755    0.027   28.404    0.000
##     ret_3             0.723    0.026   27.642    0.000
## 
## Covariances:
##                    Estimate  Std.Err  z-value  P(>|z|)
##   engagement ~~                                       
##     retention         0.364    0.032   11.542    0.000
## 
## Variances:
##                    Estimate  Std.Err  z-value  P(>|z|)
##    .eng_1             0.254    0.019   13.371    0.000
##    .eng_2             0.197    0.015   13.416    0.000
##    .eng_3             0.322    0.019   16.622    0.000
##    .ret_1             0.484    0.030   16.129    0.000
##    .ret_2             0.174    0.014   12.426    0.000
##    .ret_3             0.213    0.014   14.812    0.000
##     engagement        0.630    0.041   15.441    0.000
##     retention         0.895    0.061   14.577    0.000
\end{verbatim}
...
\textbf{\(\textbf k\)}-Means Clustering**
