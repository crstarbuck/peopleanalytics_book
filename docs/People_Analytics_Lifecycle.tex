...
\item
  \texttt{turnover\_rate}: Overall trailing 12-month (TTM) turnover rate, calculated by dividing the termination count into the average end-of-month headcount for the respective TTM period
\end{itemize}
...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//Rtmp5PS5G7/downloaded_packages
\end{verbatim}
