...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpWbSHIR/downloaded_packages
\end{verbatim}
...
The proportional-odds model is based on cumulative distribution probabilities. Its intercepts are dependent on the \(j\) levels but slopes are equal as defined by:
...
The results of Brant's test indicate that we fail to reject \(H_0\) since \(p = .82\); therefore, the proportional odds assumption holds for these data.
...
\item
  What is the null hypothesis for the Brant test?
\end{enumerate}
