...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpqMMApP/downloaded_packages
\end{verbatim}
...
\textbf{Cliff's delta} provides the effect size for ordinal variables. Simply put, Cliff's delta measures how often a value in one distribution is higher than values in another, and this is appropriate in situations in which a Wilcoxon-Mann-Whitney test is used. This statistic can be produced using the \texttt{cliff.delta()} function from the \texttt{effsize} package in R.
