...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Principal axis factoring using 19 factors and oblimin rotation}
\NormalTok{efa.fit }\OtherTok{\textless{}{-}}\NormalTok{ psych}\SpecialCharTok{::}\FunctionTok{fa}\NormalTok{(survey\_dat, }\AttributeTok{nfactors =} \DecValTok{19}\NormalTok{, }\AttributeTok{rotate =} \StringTok{\textquotesingle{}oblimin\textquotesingle{}}\NormalTok{)}
