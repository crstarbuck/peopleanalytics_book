...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpTWczx0/downloaded_packages
\end{verbatim}
...
{\centering \includegraphics[width=0.5\linewidth]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_lifecycle_book/graphics/conventional_effect_size_table} 

}

\caption{Critical Values of Student's t Distribution}\label{fig:conv-eff-size-tbl}
\end{figure}
...
\FunctionTok{exp}\NormalTok{(}\FunctionTok{coef}\NormalTok{(glm.fit)[}\DecValTok{2}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{exp}\NormalTok{(}\FunctionTok{coef}\NormalTok{(glm.fit)[}\DecValTok{3}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\) percent \emph{increase} in the odds of being active for those with a job level of 2 or greater relative to those with a job level of 1.
