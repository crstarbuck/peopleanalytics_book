...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpHdKIIf/downloaded_packages
\end{verbatim}
...
EFA will be illustrated by implementing a three-step extraction method outlined by Hair et al.~(2006):
...
##    0.94    0.90    0.90    0.84    0.90    0.89    0.93    0.91    0.93    0.91 
##   ret_3  ldrshp 
##    0.90    0.93
\end{verbatim}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Lifecycle_files/figure-latex/scree-plot-1} 
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Lifecycle_files/figure-latex/pca-var-plot-1} 
...
## 
##                  MR1   MR2   MR3
## SS loadings    2.793 2.657 1.627
## Proportion Var 0.233 0.221 0.136
## Cumulative Var 0.233 0.454 0.590
\end{verbatim}
...
{\centering \includegraphics[width=1\linewidth]{People_Analytics_Lifecycle_files/figure-latex/fct-ld-diagram-1} 
