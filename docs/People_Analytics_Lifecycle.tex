...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpPcMKwd/downloaded_packages
\end{verbatim}
...
Our resulting equation for estimating \texttt{turnover\_rate} on the basis of a combination of values for \texttt{year}, \texttt{month}, and \texttt{remote} is defined by:
