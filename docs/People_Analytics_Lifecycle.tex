...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpR3cppN/downloaded_packages
\end{verbatim}
...
\item
  \textbf{Precision}: Rate of predicted true cases predicted correctly
\item
  \textbf{Negative Predictive Value}: Rate of predicted false cases predicted correctly
\end{itemize}

\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_lifecycle_book/graphics/confusion_matrix} 
