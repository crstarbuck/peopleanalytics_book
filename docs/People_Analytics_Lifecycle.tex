...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpPaHj5h/downloaded_packages
\end{verbatim}
...
Let's run the chi-square test of independence to determine whether these residuals are significant. This test can be performed in R using the \texttt{chisq.test()} function:
