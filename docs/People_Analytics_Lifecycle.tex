...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpiKZWVq/downloaded_packages
\end{verbatim}
...
\includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-49-1.pdf}
...
Let's demonstrate stratified random sampling in R by sampling \(\frac{1}{2}\) of employees within each department. First, we can review counts of employees for each department using the group\_by() and summarise() functions from the \texttt{dplyr} library:
...
Univariate and bivariate analysis can be either descriptive or inferential. This chapter will cover descriptive techniques, while Chapter \ref{inf-stats} will cover inferential methods.
...
\KeywordTok{ggplot}\NormalTok{(employees, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{as.factor}\NormalTok{(ed_lvl), }\DataTypeTok{y =}\NormalTok{ annual_comp, }\DataTypeTok{color =}\NormalTok{ gender)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Education Level"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Annual Compensation"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-65-1.pdf}
...
\KeywordTok{round}\NormalTok{(}\KeywordTok{skewness}\NormalTok{(employees}\OperatorTok{$}\NormalTok{org_tenure), }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{aes}\NormalTok{(employees}\OperatorTok{$}\NormalTok{org_tenure) }\OperatorTok{+}\StringTok{ }
...
\KeywordTok{round}\NormalTok{(}\KeywordTok{kurtosis}\NormalTok{(employees}\OperatorTok{$}\NormalTok{org_tenure), }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{cov}\NormalTok{(employees[, }\KeywordTok{c}\NormalTok{(}\StringTok{"annual_comp"}\NormalTok{, }\StringTok{"age"}\NormalTok{, }\StringTok{"org_tenure"}\NormalTok{, }\StringTok{"job_tenure"}\NormalTok{, }\StringTok{"prior_emplr_cnt"}\NormalTok{, }\StringTok{"commute_dist"}\NormalTok{)], }\DataTypeTok{use =} \StringTok{"complete.obs"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{cor}\NormalTok{(employees[, }\KeywordTok{c}\NormalTok{(}\StringTok{"annual_comp"}\NormalTok{, }\StringTok{"age"}\NormalTok{, }\StringTok{"org_tenure"}\NormalTok{, }\StringTok{"job_tenure"}\NormalTok{, }\StringTok{"prior_emplr_cnt"}\NormalTok{, }\StringTok{"commute_dist"}\NormalTok{)], }\DataTypeTok{use =} \StringTok{"complete.obs"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{M <-}\StringTok{ }\KeywordTok{cor}\NormalTok{(employees[, }\KeywordTok{c}\NormalTok{(}\StringTok{"annual_comp"}\NormalTok{, }\StringTok{"age"}\NormalTok{, }\StringTok{"org_tenure"}\NormalTok{, }\StringTok{"job_tenure"}\NormalTok{, }\StringTok{"prior_emplr_cnt"}\NormalTok{, }\StringTok{"commute_dist"}\NormalTok{)], }\DataTypeTok{use =} \StringTok{"complete.obs"}\NormalTok{)}
...
\includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-79-1.pdf}
...
\CommentTok{# Visualize correlation matrix}
\KeywordTok{ggpairs}\NormalTok{(employees[, }\KeywordTok{c}\NormalTok{(}\StringTok{"annual_comp"}\NormalTok{, }\StringTok{"age"}\NormalTok{, }\StringTok{"org_tenure"}\NormalTok{, }\StringTok{"job_tenure"}\NormalTok{, }\StringTok{"prior_emplr_cnt"}\NormalTok{, }\StringTok{"commute_dist"}\NormalTok{)])}
\end{Highlighting}
\end{Shaded}

\includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-80-1.pdf}
...
{\centering \includegraphics{People_Analytics_Lifecycle_files/figure-latex/unnamed-chunk-88-1} 

}

\caption{Uniform Population Distribution (N = 1000)}\label{fig:unnamed-chunk-88}
\end{figure}
...
\caption{Distribution of 10,000 Sample Means of Varied Size}\label{fig:unnamed-chunk-89}
\end{figure}
...
First, let's load the \texttt{sqldf} library and load the data sets:
...
\NormalTok{orig_comp <-}\StringTok{ }\NormalTok{employees[employees}\OperatorTok{$}\NormalTok{employee_id }\OperatorTok{==}\StringTok{ '2176'}\NormalTok{, }\StringTok{'annual_comp'}\NormalTok{]}
...
\NormalTok{employees[}\KeywordTok{is.na}\NormalTok{(employees}\OperatorTok{$}\NormalTok{annual_comp), }\KeywordTok{c}\NormalTok{(}\StringTok{"employee_id"}\NormalTok{, }\StringTok{"job_title"}\NormalTok{, }\StringTok{"job_lvl"}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{imputed_comp <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(employees[employees}\OperatorTok{$}\NormalTok{job_title }\OperatorTok{==}\StringTok{ 'Manufacturing Director'} \OperatorTok{&}\StringTok{ }\NormalTok{employees}\OperatorTok{$}\NormalTok{job_lvl }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{, }\StringTok{'annual_comp'}\NormalTok{], }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
...
\KeywordTok{abs}\NormalTok{(orig_comp }\OperatorTok{-}\StringTok{ }\NormalTok{employees[employees}\OperatorTok{$}\NormalTok{employee_id }\OperatorTok{==}\StringTok{ '2176'}\NormalTok{, }\StringTok{'annual_comp'}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
Fields with low variability can be easily identified using descriptive statistics from the \texttt{summary()} function. If the \texttt{Min} and \texttt{Max} values are equal, there is no variability in the field's values. Based on the following descriptives, we should remove \texttt{standard\_hours} from the data:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Return descriptives to understand distribution of standard hours}
\KeywordTok{summary}\NormalTok{(employees}\OperatorTok{$}\NormalTok{standard_hours)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{head}\NormalTok{(employees[, }\KeywordTok{c}\NormalTok{(}\StringTok{"employee_id"}\NormalTok{, }\StringTok{"gender_ohe"}\NormalTok{)])}
\end{Highlighting}
\end{Shaded}
