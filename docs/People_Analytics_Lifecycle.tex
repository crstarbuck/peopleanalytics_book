...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//Rtmp5yJDJW/downloaded_packages
\end{verbatim}
...
\hypertarget{data-wrangl}{%
\chapter{Data Wrangling}\label{data-wrangl}}
...
\item
  What is the difference between structural and informative missingness?
\item
...
\item
  What does a value of \texttt{NA} indicate in a data set within R?
\item
  What additional variables could be derived from standard data elements?
\end{enumerate}
