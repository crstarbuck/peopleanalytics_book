...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpLE9tdo/downloaded_packages
\end{verbatim}
...
\caption{Density plots comparing distributions with a mean of 100 (blue) and 120 (grey) with sample sizes of 100, 1000, and 10000 (rows) and standard deviations of 25, 50, and 75. Dashed vertical lines represent distribution means.}\label{fig:mean-group-diff}
\end{figure}
