...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//RtmpK0cu1D/downloaded_packages
\end{verbatim}
...
\caption{Table of Correlation Coefficients}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Correlation between Maine Divorce Rate and Margarine Consumption (r = .99)}\label{fig:unnamed-chunk-25}
\end{figure}
...
\caption{Correlation between Mozzarella Cheese Consumption and Civil Engineering Doctorate Conferrals (r = .96)}\label{fig:unnamed-chunk-26}
\end{figure}
...
\caption{The Empirical Rule}\label{fig:unnamed-chunk-27}
\end{figure}
...
\caption{Uniform Population Distribution (N = 1000)}\label{fig:unnamed-chunk-30}
\end{figure}
...
\caption{Distribution of 100 Sample Means of Varied Size}\label{fig:unnamed-chunk-31}
\end{figure}
...
\caption{Type I and II Errors}\label{fig:unnamed-chunk-40}
\end{figure}
...
\begin{figure}
\includegraphics[width=25.81in]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_lifecycle_book/graphics/4d_framework} \caption{Figure 1: 4D Framework}\label{fig:unnamed-chunk-41}
\end{figure}
