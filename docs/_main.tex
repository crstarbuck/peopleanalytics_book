...
##  /var/folders/b1/0nnhbsx55hvfb1b3n83x0qrw0000gn/T//Rtmp78uBmW/downloaded_packages
\end{verbatim}
...
{\centering \includegraphics[width=0.5\linewidth]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_lifecycle_book/graphics/research_designs} 
...
Since the CLT is fundamental to this, let's validate that our simulated distribution of sample means adheres to the properties of normally distributed data per the Empirical Rule. It is important to note, however, that CIs do not relate to the distribution of sample means (a common misinterpretation):
