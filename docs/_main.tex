...
\begin{figure}
\includegraphics[width=25.81in]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/Graphics/4D Framework} \caption{Figure 1: 4D Framework}\label{fig:unnamed-chunk-4}
\end{figure}
