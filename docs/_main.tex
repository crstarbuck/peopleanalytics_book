...
\NormalTok{data <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/crstarbuck/peopleanalytics_lifecycle_book/master/data/files/employee_demographics.csv"}\NormalTok{)}

\CommentTok{# Calculate sample variance for compensation}
\KeywordTok{var}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# Calculate population variance for compensation}
\KeywordTok{var}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation) }\OperatorTok{*}\StringTok{ }\NormalTok{(n }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{/}\StringTok{ }\NormalTok{n}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Calculate sample standard deviation for compensation}
\KeywordTok{sd}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Calculate population standard deviation for compensation}
\KeywordTok{sd}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation) }\OperatorTok{*}\StringTok{ }\KeywordTok{sqrt}\NormalTok{((n }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{/}\StringTok{ }\NormalTok{n)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Return quartiles for compensation}
\KeywordTok{quantile}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##        0%       25%       50%       75%      100% 
##   50059.0   87333.5   95666.0  103787.0 1749256.0
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Return 80th percentile compensation value}
\KeywordTok{quantile}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation, }\DataTypeTok{probs =} \FloatTok{.8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{summary}\NormalTok{(data}\OperatorTok{$}\NormalTok{annual_base_compensation)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##   50059   87334   95666  102019  103787 1749256
\end{verbatim}
...
\caption{The Empirical Rule}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{Uniform Population Distribution (N = 1000)}\label{fig:unnamed-chunk-19}
\end{figure}
...
\caption{Distribution of 100 Sample Means of Varied Size}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Type I and II Errors}\label{fig:unnamed-chunk-29}
\end{figure}
...
\begin{figure}
\includegraphics[width=25.81in]{/Users/craig.starbuck/Library/Mobile Documents/com~apple~CloudDocs/Documents/People Analytics Book/GitHub/peopleanalytics_lifecycle_book/graphics/4d_framework} \caption{Figure 1: 4D Framework}\label{fig:unnamed-chunk-30}
\end{figure}
